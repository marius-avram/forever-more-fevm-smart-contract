...
contract DealRewarder {
    ...
    mapping(bytes32 => uint) dealsCreationTime;

    mapping(address => uint) public funds;

    // TODO: Deprecated sould remove following 3 lines
    ...
    function addCID(bytes calldata cidraw, uint size, uint replicas, uint period) public {


        // Create the bounty
        bytes32 bountId = computeBountyId(cidraw);
